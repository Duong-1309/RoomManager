...
public class DatabaseConnection {
    ...
    /**
     * Get the connection to the SQLite database. If the connection does not exist,
     * it will create a new connection and initialize tables if they do not exist.
     *
    ...
    /**
     * Create required tables if they do not already exist in the database.
     */
